...
<img src="https://cdn.jsdelivr.net/gh/guaguaupup/cloudimg/data/202210121018707.png" alt="图片" style="zoom: 67%;" />
...
- **消息队列**
  ...
  消息队列的生命周期与内核相关，如果不显示地删除消息队列，则消息队列会一直存在
...
- **读-写自旋锁**
  ...
  当一个或者多个读任务时可以并发的持有读锁，但是写锁只能被一个人物所持有的。即对写者排斥对读者共享
